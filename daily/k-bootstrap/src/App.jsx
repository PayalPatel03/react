            ...
            <div className="row justify-content-center">
              ...
              >
                <p>
                  ...
                  commodi voluptatem voluptate, eum minima, in suscipit
                  explicabo voluptatibus harum, quibusdam ex repellat eaque!
                </p>
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-md-3 col-sm-6">
                <div className="footer-menu footer-menu-001">
                  ...
                  <p>
                    ...
                    fringilla elementum diam in. Nisi, purus vitae, ultrices
                    nunc. Sit ac sit suscipit hendrerit.
                  </p>
